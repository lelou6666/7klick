...
public class AuthenticationTokenProcessingFilter extends GenericFilterBean
{
	...
	public AuthenticationTokenProcessingFilter(CustomizedUserDetailService customizedUserDetailService)
	{
			...
			ServletException
	{
		...
		if (userName != null) {
			UserDetails userDetails = this.customizedUserDetailService.loadUserByUsername(userName);
