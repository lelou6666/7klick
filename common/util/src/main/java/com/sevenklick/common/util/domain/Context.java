...
public class Context {
    ...
    public Context(String ticket) throws TicketNotValidException {
        try{
            ...
            addContextValue(CONTEXT_PLCID, user.getPlcId());
            addContextValue(CONTEXT_USERNAME, user.getUserName());
            addContextValue(CONTEXT_LANGCODE, user.getLangCode());
            addContextValue(CONTEXT_COUNTRYCODE, user.getCountryCode());
            addContextValue(CONTEXT_ROLE, user.getRoleCode());
            addContextValue(CONTEXT_ADMINENABLED, user.getAdminEnabled());
