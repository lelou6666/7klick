...
<div class="row">
    ...
    <div class="col-md-6">
        <form class="form-horizontal" action="/common-web/authenticate" method="post">
    ...
    <div class="col-md-6">
        <p class="alert alert-info">Login with either user:user to read entries or with admin:admin to read and edit entries.</p>
    </div>
